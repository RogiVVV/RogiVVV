...
### 📩 [Телеграм бот для пересылки сообщений](https://github.com/RogiVVV/Telegram-message-forwarder)

> Телеграм бот, который может пересылать сообщения из чатов/каналов/групп в ваш

**Стек:** Python, SQL, aiohttp
